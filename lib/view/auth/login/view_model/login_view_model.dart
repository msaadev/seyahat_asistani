...
abstract class _LoginViewModelBase with Store {
  ...
  UserData user = UserData(uid: "", email: "", name: "", fuelCost: "", totalCalories: "", totalDrive: "", totalWalk: "");
  ...
  Future login({required String email, required String password}) async {
    ...
    if (request.user != null) {
      ...
      dat.then((e) => {
        user = UserData(uid: e.data()["uid"], email: e.data()["email"], name: e.data()["name"], fuelCost: e.data()["fuelCost"], totalCalories: e.data()["totalCalories"], totalDrive: e.data()["totalDrive"], totalWalk: e.data()["totalWalk"])
      });
      await CacheManager.instance.setUserData(user);
